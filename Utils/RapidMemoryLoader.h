...
public:
    ...
    template<ReqFileLoaderable SEG_MAP_MODE>
    ...
    template<ReqMemLoaderable SEG_MAP_MEM_MODE_>
    void AppendMoreSegs(SEG_MAP_MEM_MODE_ Segs) {
        seg_map_.emplace_back(Segs.base_, Segs.size_, Segs.buffer_);
    }
